...
public class DownloadHtmlSource extends  Thread{
    ...
    public static Logger logger = (Logger)Logger.getLogger(String.valueOf(DownloadHtmlSource.class));
    ...
    private  static  void downloadBySelenium(WebDriver driver, String keywords, String startTime, String endTime){
